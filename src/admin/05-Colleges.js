...
import '../admin_css/05-Colleges.css'
...
class Colleges extends Component {
    ...
    colleges_render = props => {
        ...
        const college = _ => {
            return (
                <div class="colleges_contents_admin">
                    <Link to={{ 
                        pathname: `/yultnbimscsXzBUKKhwaq@@@@4t4t4E9L4Xrr7;fadjsjfdsajfpjwa543666433lkjfU8Dq3q@534fgdgjtsryh8836jggjdid;;3flsZ/colleges/${props.college_id}`,
    ...
    render() {
        ...
        return (
            <section id="admin_explore">
                <p>Colleges</p>
                <Link to="/yultnbimscsXzBUKKhwaq@@@@4t4t4E9L4Xrr7;fadjsjfdsajfpjwa543666433lkjfU8Dq3q@534fgdgjtsryh8836jggjdid;;3flsZ/colleges/add">Add College</Link>
                <div class="colleges_filters_admin">
